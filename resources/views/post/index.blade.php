                ...
                <div class="sm:mt-4 sm:ml-2">
                    ...
                    <div class="hidden sm:block">
                      <nav class="-mb-px flex space-x-8">
                        <x-post-nav :href="route('posts.index')" :active="request()->routeIs('posts.index')">All</x-post-nav>
                        <x-post-nav :href="route('posts.trash')" :active="request()->routeIs('posts.trash')">Trash</x-post-nav>                      </nav>
                    </div>
                </div>
            </div>
        </div>
